...
export const Empty = ({ title, desc, button }: IProps) => {
  return (
    <div className="w-full flex justify-center">
      <div className="w-full max-w-[800px] bg-white flex-col shadow-sm rounded-xl border-stroke border p-6 sm:py-12 flex justify-center items-center sm:px-8">
